...
export type CheckUserQuery = { __typename?: 'Query', checkUser: { __typename?: 'User', _id: string, nickname: string, email: string, createdAt: string, emailVerification: { __typename?: 'TokenInfo', isVerified: boolean | null, token: string | null, expiresAt: string | null }, resetPassword: { __typename?: 'TokenInfo', token: string | null, expiresAt: string | null, isVerified: boolean | null }, purchasedInfo: { __typename?: 'PurchasedInfo', isPurchased: boolean, purchasedAt: string | null, expiresAt: string | null } } | null };
