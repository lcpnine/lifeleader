...
export type SignInMutation = { __typename?: 'Mutation', signIn: { __typename?: 'SignInFailure', errorType: SignInFailureType } | { __typename?: 'SignInSuccess', token: string, user: { __typename?: 'User', _id: string, email: string, nickname: string, createdAt: string, emailVerification: { __typename?: 'TokenInfo', isVerified: boolean | null, token: string | null, expires: string | null }, resetPassword: { __typename?: 'TokenInfo', token: string | null, expires: string | null, isVerified: boolean | null }, purchasedInfo: { __typename?: 'PurchasedInfo', isPurchased: boolean, purchasedAt: string | null, expiresAt: string | null } } } };
