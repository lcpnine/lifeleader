...
const Home = () => {
  const { currentLanguage, getTranslation, metaTranslation } = useI18n()
  ...
  return (
    <>
      <Head>
        <title>{metaTranslation('HomeTitle')}</title>
        <meta name="description" content={metaTranslation('HomeDescription')} />
      </Head>
