  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <div className="flex justify-center items-center gap-4 mb-4">
        <button
          className="md:text-xs bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
          onClick={handleCreateChartClick}
        >
          Start Creating Your Mandala Chart
        </button>
        <button
          className="md:text-xs bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded"
